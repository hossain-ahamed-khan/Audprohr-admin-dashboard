...
export default function AdministratorPage() {
    return (
        <div className="bg-[#FFFFFF] w-full mx-auto rounded-2xl py-4 px-12 mt-4 shadow-md">
            <AlertDialog>
                <AlertDialogTrigger className="flex gap-2 items-center bg-[#4B2A99] text-white px-4 py-2 rounded-3xl cursor-pointer">New Administrator Profile Create</AlertDialogTrigger>
                <AlertDialogContent>
                    <AlertDialogHeader>
