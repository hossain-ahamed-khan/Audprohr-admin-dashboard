    ...
    return (
        <div className='bg-[#F8F8FF] w-full h-screen flex justify-center items-center flex-col'>
            <div className="w-11/12 md:w-1/4 mx-auto space-y-4 text-[#1A1A40]">
                ...
                <Link href="/admin-login/forget-password/enter-otp/set-password/password-update-success"><Button className="w-full py-5 text-white rounded-3xl mt-10">Reset Password</Button></Link>
